...
const ComicStripTool: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    doc.text(WATERMARK_TEXT, pageWidth / 2, 290, { align: 'center' });
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-600 dark:text-slate-400">Turn your images into a structured 4-panel comic strip.</p>
      </div>
         ...
         <div className="md:col-span-2 space-y-6">
            ...
            {comicData && (
               <div className="space-y-6 animate-fade-in-up">
                  <div className="bg-white p-8 rounded-sm shadow-2xl border-4 border-black max-w-xl mx-auto">
                     {/* Title Block */}
                     <div className="bg-yellow-300 border-2 border-black p-4 mb-6 text-center shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                     ...
                     <div className="space-y-6">
                        {comicData.pages.map((panel, idx) => (
                           <div key={idx} className="flex gap-4">
                              {/* Panel Image */}
                              <div className="w-1/2 aspect-square border-2 border-black bg-slate-100 relative overflow-hidden">
                                 {panel.imageUrl ? (
                              ...
                              <div className="w-1/2 flex items-center">
                                 <div className="bg-white border-2 border-black p-4 rounded-[20px] relative shadow-[2px_2px_0px_rgba(0,0,0,0.2)] text-black font-mono text-sm leading-snug">
                                    {/* Bubble Tail */}
