...
import { CalendarCheck, Mail, Clock, Calendar, Users, Download, Send, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl space-y-6">
         <div className="space-y-4">
            ...
            <div>
               ...
               <input 
                  ...
                  className={`w-full bg-slate-950 border rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 ${emailError ? 'border-red-500 focus:ring-red-500' : 'border-slate-700 focus:ring-cyan-500'}`}
                  placeholder="email@example.com, another@example.com"
               />
               {emailError && (
                  <p className="text-red-400 text-xs mt-1 flex items-center gap-1"><AlertCircle className="w-3 h-3"/> {emailError}</p>
               )}
            </div>
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
            <button
               ...
               disabled={!title || !date || !time || !attendees || !!emailError}
