...
const DocTool: React.FC = () => {
  ...
  const [filename, setFilename] = useState('ai-doc');
  ...
  const handleDownloadZip = async () => {
    ...
    chunks.forEach((chunk, idx) => {
        // Prepend watermark as header comment
        const content = `// ${WATERMARK_TEXT}\n\n${chunk}\n\n// Generated by AI Doc`;
        zip.file(`${filename}_part_${idx + 1}.txt`, content);
    });
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-600 dark:text-slate-400">Essential document utilities powered by AI.</p>
      </div>
