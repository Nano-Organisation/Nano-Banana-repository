...
const TOOLS = [
  ...
  { id: ToolId.AetherEdit, title: "AetherEdit", description: "AI-Powered Video & Sound Editor with real-time effects.", icon: Clapperboard, color: "cyan", gradient: "from-cyan-500 to-blue-600", releaseDate: '2025-12-10' },
  ...
  { id: ToolId.ImageToPrompt, title: "AI Vision", description: "Convert images to text descriptions or prompts.", icon: Scan, color: "fuchsia", gradient: "from-fuchsia-500 to-purple-600", releaseDate: '2025-12-06' },
  ...
  { id: ToolId.Pinterest, title: "AI Pinterest", description: "Generate viral-worthy, vertical Pinterest images.", icon: Pin, color: "red", gradient: "from-red-500 to-rose-600", releaseDate: '2025-12-04' },
